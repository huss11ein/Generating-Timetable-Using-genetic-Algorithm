...
MUTATION_RATE = 0.1
class Data :
    ROOMS = [["H1",25], ["H2",45], ["H3",35]]
    MEETING_TIMES = [["MT1", "MWF 09:00 - 10:00"],
                     ["MT2", "MWF 10:00 - 11:00"],
                     ["MT3", "TTH 09:00 - 10:30"],
                     ["MT4", "TTH 10:30 - 12:00"]]
    INSTRUCTORS = [["I1", "Dr. Amr Ghoniem"],
                   ["I2", "Dr. Ahmed Elsaid"],
                   ["I3", "Dr. Ramdam"],
                   ["I4", "Dr. Marwa"]]
    def __init__(self):
        ...
        course1 = Course("C1", "177CS", [self._instructors[0], self._instructors[1]], 25)
        course2 = Course("C2", "115CS", [self._instructors[0], self._instructors[1], self._instructors[2]],35)
        course3 = Course("C3", "525IS", [self._instructors[0], self._instructors[1]], 25)
        course4 = Course("C4", "167IS", [self._instructors[2], self._instructors[3]], 30)
        course5 = Course("C5", "758IT", [self._instructors[3]], 35)
        course6 = Course("C6", "385IT", [self._instructors[0], self._instructors[2]], 45)
        course7 = Course("C7", "925CS", [self._instructors[1], self._instructors[3]], 45)
        self._courses = [course1, course2, course3, course4, course5, course6, course7]
        dept1 = Department('CS', [course1, course3])
        dept2 = Department('AI', [course2, course4, course5])
        dept3 = Department('CO', [course6, course7])
...
class GeneticAlgorithm:
    ...
    def _rossover_population(self, pop):
...
class DisplayMgr:
    ...
    def print_generation(self, population):
        ...
        for i in range(0, len(schedules)):
            table1.add_row([str(i), round(schedules[i].get_fitness(),3), schedules[i].get_numberOfConflicts(), schedules[i].get_classes()])
        print(table1)
...
while (population.get_schedules()[0].get_fitness() != 1.0):
    generationNumber += 1
    print('n\> Generation # ' + str(generationNumber))
